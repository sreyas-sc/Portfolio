  ...
  return (
    <div className="content">
      <div className="left">
        ...
        {/* card about me */}
        <div class="abtmespacecard">
        <div className="abtmespaceimg">
  <img src={MyImg} alt="Profile Image" className="profile-img" />
</div>
  <span>About Me</span>
  <p class="abtmespaceinfo">I’m Sreyas from kerala, I learned Python, C++, c, Dart, Java, JavaScript etc, Worked with libraries & frameworks like ReactJS, NodeJS. Have a keen knowledge of databases like MySQL, MongoDB and Firebase. Eager to contribute to innovative projects and gain hands-on experience in a dynamic and collaborative</p>
  <div class="abtmespaceshare">
